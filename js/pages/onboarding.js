...
function pgOnboard(){
  ...
  const slides=[
    {salo:'happy',tk:'ob1_t',dk:'ob1_d'},
    {salo:'thinking',tk:'ob2_t',dk:'ob2_d'},
    {salo:'celebrating',tk:'ob3_t',dk:'ob3_d'}
  ];
  ...
  const slideEls=slides.map(s=>{
    ...
    slide.appendChild(el('div',{class:'obart'},saloEl(s.salo,{size:110,className:'salo-bob'})));
