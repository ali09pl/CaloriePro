...
let S={
  ...
  // Rolling AI chat memory: short summary string + last few turns only.
  // Never grows unbounded — see foldAIHistory() in js/pages/ai.js.
  aiChat:LS.get('cp7_aic',{summary:'',turns:[]}),
};
function saveS(){
