...
function pgHome(){
  ...
  hi.appendChild(el('div',{style:{fontSize:'60px',marginBottom:'12px',filter:'drop-shadow(0 4px 14px rgba(16,185,129,.4))'}},'🥗'));
  ...
  if(!S.plan){
    ...
    cta.appendChild(el('div',{style:{fontSize:'50px',marginBottom:'12px'}},'🎯'));
