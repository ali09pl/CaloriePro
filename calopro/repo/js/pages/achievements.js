...
function pgAch(){
  ...
  sc.appendChild(el('div',{style:{fontSize:'34px',marginBottom:'8px'}},'🏆'));sc.appendChild(el('div',{style:{fontSize:'34px',fontWeight:'900',lineHeight:'1'}},unl+' / '+ACHIEVEMENTS.length));sc.appendChild(el('div',{style:{fontSize:'11px',color:'var(--tx2)',letterSpacing:'1px',textTransform:'uppercase',marginTop:'5px'}},'Achievements Unlocked'));sc.appendChild(el('div',{style:{fontSize:'16px',fontWeight:'700',color:'var(--pu2)',marginTop:'9px'}},'⭐ '+fmt(totalXP)+' '+__('xp_pts')));
